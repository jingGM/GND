...
#include "sc_liosam/cloud_info.h"
...
// void saveKeyFrameTimeStamps(std::string _filename)
...
public:
    ...
    // ros::Publisher pubLaserCloudTest;
    ...
    sc_liosam::cloud_info cloudInfo;
...
public:
    mapOptimization()
    {
        ...
        pubKeyPoses                 = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/trajectory", 1);
        pubLaserCloudSurround       = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/map_global", 1);
        pubLaserOdometryGlobal      = nh.advertise<nav_msgs::Odometry> ("sc_liosam/mapping/odometry", 1);
        pubLaserOdometryIncremental = nh.advertise<nav_msgs::Odometry> ("sc_liosam/mapping/odometry_incremental", 1);
        pubPath                     = nh.advertise<nav_msgs::Path>("sc_liosam/mapping/path", 1);

        subCloud = nh.subscribe<sc_liosam::cloud_info>("sc_liosam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        subGPS   = nh.subscribe<nav_msgs::Odometry> (gpsTopic, 200, &mapOptimization::gpsHandler, this, ros::TransportHints().tcpNoDelay());
        subLoop  = nh.subscribe<std_msgs::Float64MultiArray>("lio_loop/loop_closure_detection", 1, &mapOptimization::loopInfoHandler, this, ros::TransportHints().tcpNoDelay());

        pubHistoryKeyFrames   = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/icp_loop_closure_history_cloud", 1);
        pubIcpKeyFrames       = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/icp_loop_closure_corrected_cloud", 1);
        pubLoopConstraintEdge = nh.advertise<visualization_msgs::MarkerArray>("/sc_liosam/mapping/loop_closure_constraints", 1);

        pubRecentKeyFrames    = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/map_local", 1);
        pubRecentKeyFrame     = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/cloud_registered", 1);
        pubCloudRegisteredRaw = nh.advertise<sensor_msgs::PointCloud2>("sc_liosam/mapping/cloud_registered_raw", 1);
        // pubLaserCloudTest = nh.advertise<sensor_msgs::PointCloud2> ("sc_liosam/deskew/cloud_ori", 1);
    ...
    void allocateMemory()
    {
        ...
        laserCloudOriginal.reset(new pcl::PointCloud<PointType>()); // giseop
    ...
    void laserCloudInfoHandler(const sc_liosam::cloud_infoConstPtr& msgIn)
    {
        // extract time stamp
        ...
        pcl::fromROSMsg(msgIn->cloud_ori,  *laserCloudOriginal); // giseop
    ...
    void saveKeyFramesAndFactor()
    {
        ...
        std::string curr_scd_node_idx = std::to_string(laserCloudRawTime);
        ...
        // std::cout<<"----------------------1------------------------"<<std::endl;
        pcl::PointCloud<PointType>::Ptr thisKeyFrameCloud(laserCloudOriginal);
        // *thisKeyFrameCloud += *laserCloudRaw;
        // std::cout<<"----------------------2------------------------"<< laserCloudOriginal->size()<<std::endl;
        // *thisKeyFrameCloud += *laserCloudOriginal;
        pcl::io::savePCDFileBinary(saveNodePCDDirectory + curr_scd_node_idx + ".pcd", *thisKeyFrameCloud);

        // publishCloud(&pubLaserCloudTest, laserCloudOriginal, cloudInfo.header.stamp, lidarFrame);
        // pubLaserCloudTest.publish(cloudInfo.cloud_ori);
        // 
