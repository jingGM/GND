...
public:
    ...
    deskewFlag(0)
    {
        ...
        pubExtractedCloud = nh.advertise<sensor_msgs::PointCloud2> ("sc_liosam/deskew/cloud_deskewed", 1);
        pubLaserCloudInfo = nh.advertise<sc_liosam::cloud_info> ("sc_liosam/deskew/cloud_info", 1);
